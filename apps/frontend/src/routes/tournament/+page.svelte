...
>
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    >
      <div
        class="overflow-x-auto flex flex-col md:flex-row gap-4 justify-center"
      >
        <input
          type="text"
        ...
        <select
          bind:value={limit}
          class="flex-1px-4 py-2 rounded-lg text-black text-sm font-bold"
        >
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full">
            ...
            <tbody class="divide-y divide-cyan-400/20">
              {#each tournaments as t: Tournament}
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-right">
                    <div class="flex justify-end gap-2">
                      ...
                      {#if t.status === 'completed'}
                        <span
                          class="inline-flex items-center px-4 py-2 text-[10px] font-bold text-yellow-400/50"
                        >
                        </span>
                      {/if}
                    </div>
